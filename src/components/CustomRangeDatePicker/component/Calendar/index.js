...
class Calendar extends React.Component {
  ...
  renderCalendarDate = (date, index) => {
    ...
    // let isCurrent = !!current && isSameDay(thisDay, current);
    const isCurrent =
      new Date(moment(this.props.date)).getTime() ===
        thisDay.getTime() + 19800000 ||
      new Date(moment(this.props.endDate)).getTime() ===
        thisDay.getTime() + 19800000 ||
      new Date(moment(this.props.date)).getTime() === thisDay.getTime() ||
      new Date(moment(this.props.endDate)).getTime() === thisDay.getTime();
    // console.log(
    //   'thisDay',
    //   thisDay,
    //   new Date(moment(this.props.endDate)).getTime(),
    ...
    // const StartDate = new Date(this.props.date).toLocaleDateString();
    // const EndDate = new Date(this.props.endDate).toLocaleDateString();
    const isWeekend = this.props.weekEnds.includes(thisDay.getDay());
    const startDateUI =
      new Date(moment(this.props.date)).getTime() ===
      thisDay.getTime() + 19800000;
    const EndDateUI =
    ...
    //   thisDay.getTime(),
    //   new Date(moment(this.props.endDate)).getTime(),
    //   // new Date(moment(this.props.endDate)),
    //   // new Date(moment(this.props.date)).getTime(),
    //   // new Date(moment(this.props.endDate)).getTime(),
    ...
    if (
      ...
      // alert('todfk54545fk');
      // console.log('First Loop', thisDay);
      inRangeDate = true;
      // if (
      //   new Date(moment(this.props.date)).getTime() ===
      //     thisDay.getTime() + 19800000 ||
      ...
      // ) {
      //   isCurrent = true;
      //   console.log('second Loop', thisDay);
      ...
      <>
        ...
        >
          {isCurrent ? (
            ...
            //  isToday ? (
            //   <TodayCalendarDate>{thisDay.getDate()}</TodayCalendarDate>
            // ) :
            thisDay.getDate()
          )}
          {/* {thisDay.getDate()} */}
