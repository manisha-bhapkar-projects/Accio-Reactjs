...
import './CardListTableTablet.scss';
...
function CardListTableTablet(props) {
  const {
    data,
    columns,
    total,
  ...
  return (
    <div
      className={
        numberOfCol() > 4
          ? 'card-list-table-tablet'
          : 'card-list-table-tablet col-less-equal-4'
      }
    >
      {total && !pending ? (
        <div className="total">
...
CardListTableTablet.defaultProps = {
  total: false,
...
export default CardListTableTablet;
